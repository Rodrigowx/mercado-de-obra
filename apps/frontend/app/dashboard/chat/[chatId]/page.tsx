...
export default function ChatPage({ params }: { params: { chatId: string } }) {
  ...
  // =========================================================================
  return (
    <div className="max-w-[1400px] h-[93svh] mx-auto px-4 md:px-8 py-4 flex flex-col transition-colors rounded-md shadow-lg animate__animated animate__fadeIn">
      {/* Header */}
      <div className="flex items-center h-auto justify-between mb-3 pb-3 border-b dark:border-gray-700">
      ...
      <div className="h-[93svh]">
        {/* Main */}
        <div className="flex flex-row h-auto bg-gray-100 dark:bg-gray-900 md:flex-row space-y-4 md:space-y-0 md:space-x-4 animate__animated animate__fadeInUp">
          {/* Chat Column */}
          <div className="flex flex-col h-auto w-full">
            <div className="w-full h-[75svh] overflow-hidden hover:overflow-y-auto bg-white dark:bg-gray-800 rounded-lg border border-gray-300 dark:border-gray-700 flex flex-col shadow-inner">
              {/* Messages */}
            ...
            <div className="border-t flex-col border-gray-300 dark:border-gray-700 flex bg-gray-50 dark:bg-gray-800 shrink-0">
              ...
              <div className="flex items-center justify-between w-full px-2 py-2 gap-2">
                <textarea
                  className="flex-1 h-12 min-h-[48px] max-h-24 resize-none bg-gray-100 dark:bg-gray-700 p-2 rounded-md border border-gray-300 dark:border-gray-600 focus:outline-hidden focus:ring-1 focus:ring-orange-500 focus:border-orange-500 text-gray-700 dark:text-gray-200 text-sm"
          ...
          {isProfessional && showBudgetPanel && (
            <div className="w-full h-[83svh] md:w-96 bg-white dark:bg-gray-800 rounded-lg border border-gray-300 dark:border-gray-700 p-4 flex flex-col animate__animated animate__fadeInRight">
              ...
              {needsLoading ? (
                ...
                <div className="mb-4">
                  ...
                  <select
                    className="w-full p-2 border rounded-sm bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-100"
              ...
              <textarea
                className="w-full p-2 mb-4 rounded-sm border bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-100"
                value={description}
              ...
              <div className="flex-1 overflow-y-auto border-t pt-2 h-svh">
                {budgetServices.map((bs, idx) => (
                  <div key={idx} className="mb-3 border-b pb-2">
                    ...
                    <input
                      type="text"
                      className="w-full mt-1 mb-2 p-1 border rounded-sm bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-100"
                      value={bs.task}
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-2">
                      <div>
                        ...
                        <input
                          type="number"
                          step="0.1"
                          className="w-full p-1 border rounded-sm bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-100"
                          value={bs.quantity}
                          onChange={(e) =>
                            setBudgetServices((prev) =>
                              prev.map((item, i) =>
                      ...
                      <div>
                        ...
                        <select
                          className="p-1 border rounded-sm bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-100"
                    ...
                    <input
                      type="number"
                      step="0.01"
                      className="w-full p-1 border rounded-sm bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-100 mb-2"
                    ...
                    <div className="flex justify-end">
                      <button
                        ...
                        className="bg-red-600 text-white p-1 rounded-sm hover:bg-red-700"
                      >
              ...
              <button
                ...
                className="mt-4 w-full py-2 bg-orange-600 text-white rounded-sm hover:bg-orange-700 transition-colors"
              >
                Salvar
              </button>
            </div>
